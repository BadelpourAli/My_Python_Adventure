...
print(f"Good bye {person_name.lower()}!")
print(f"How are you {person_name.title()}!")
...
famous_quote = 'Albert Einstein once said, “A clever person solves a problem. A wise person avoids it.”'
print(famous_quote)
